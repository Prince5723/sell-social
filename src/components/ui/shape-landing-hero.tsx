            ...
            <div className="relative z-10 container flex flex-col items-center mx-auto px-4 md:px-6">
                <div className=" mx-auto text-center">
                    ...
                    >
                        ...
                        Forget cookie-cutter solutions. We specialize in developing custom MVPs, websites, applications, and brand identities that authentically represent your business and drive measurable success.
                        </p>
                    </motion.div>
                </div>
